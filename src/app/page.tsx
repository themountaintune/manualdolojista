export const metadata = {
  title: "Início",
  description: "Abra sua primeira loja online — com método.",
};
...
export default function Home() {
  return (
    <div className="max-w-[1200px] mx-auto px-4 md:px-6 py-10 space-y-12">
      <Hero />

      <section>
        <h2 className="text-xl font-semibold mb-4">Mais lidos</h2>
      ...
      <section>
        <h2 className="text-xl font-semibold mb-4">Explore por categoria</h2>
        <div className="flex flex-wrap gap-3">
          {[
            ...
            <button key={b.label} className="h-10 px-4 rounded-xl border hover:shadow-hover focus:outline-none focus:ring-2 focus:ring-brand-teal">
              {b.label}
            </button>
          ))}
        </div>
      ...
      <section className="p-5 rounded-2xl border">
        ...
        <div className="mt-3 flex gap-2">
          <input className="h-10 px-3 rounded-xl border border-zinc-200 w-full max-w-sm focus:outline-none focus:ring-2 focus:ring-brand-teal" placeholder="seu@e-mail.com" />
          <button className="h-10 px-4 rounded-xl bg-brand-teal text-white hover:bg-teal/90 focus:outline-none focus:ring-2 focus:ring-brand-teal">Quero receber</button>
        </div>
      </section>
