...
const materials = [
  {
    ...
    description:
      "Compare todas as principais plataformas com critérios objetivos e escolha a melhor para seu negócio.",
    cover:
      "https://images.pexels.com/photos/3184405/pexels-photo-3184405.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&fit=crop",
    type: "Planilha",
    pages: "12 páginas",
  ...
  },
  {
    ...
    description:
      "Lista completa de 47 tarefas essenciais para abrir sua loja online sem esquecer nada importante.",
    cover:
      ...
      <main className="container py-8">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-lg text-sub mb-12">
            Baixe nossos templates, planilhas e checklists criados especialmente para empreendedores
            digitais.
          </p>
          ...
          <section className="mt-16 text-center">
            <div className="card p-8">
              ...
              <button className="btn btn-primary">Sugerir Material</button>
            </div>
          </section>
        </div>
      </main>
