...
const cases = [
	{
		...
		company: "Moda & Estilo",
		description: "Estratégia completa de SEO + Google Ads que transformou uma loja local em referência nacional.",
	...
	},
	{
		...
		description: "Como uma empreendedora solteira construiu um império de cosméticos naturais do zero.",
	...
	},
	{
		...
		company: "TechGadgets",
		description: "Implementação de automação que reduziu custos e aumentou a satisfação dos clientes.",
	...
	},
	{
		...
		description: "Como diversificar vendas entre site próprio e marketplaces para maximizar receita.",
	...
	},
	{
		...
		description: "Programa de fidelidade e atendimento personalizado que criou uma comunidade engajada.",
		image: "https://images.pexels.com/photos/3184405/pexels-photo-3184405.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop",
	...
	},
	{
		...
		description: "Como uma livraria tradicional se reinventou e hoje vende mais online que na loja física.",
		image: "https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop",
		...
		<div>
			...
			<main className="container py-8">
				<div className="max-w-6xl mx-auto">
					<h1 className="text-4xl text-white font-extrabold tracking-tight mb-8">Cases de Sucesso</h1>
					<p className="text-lg text-sub mb-12">
						Histórias reais de empreendedores que transformaram seus negócios com estratégias testadas.
					</p>
							...
							<article key={i} className="card overflow-hidden">
								...
								<div className="p-6">
									<div className="flex items-center gap-2 mb-3">
										<span className="text-xs text-brand-teal font-semibold">{caseStudy.timeframe}</span>
									</div>
									...
									<div className="flex flex-wrap gap-2 mb-4">
										{caseStudy.results.map((result, j) => (
											<span key={j} className="text-xs px-2 py-1 rounded-full bg-brand-green/20 text-brand-green border border-brand-green/30">
												{result}
											</span>
										))}
									</div>
