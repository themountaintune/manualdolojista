      ...
      <main className="container py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-invert max-w-none">
            <p className="text-lg text-sub mb-6">Última atualização: 20 de janeiro de 2025</p>
            ...
            <p>
              ...
              personalizar conteúdo. Você pode desativar os cookies nas configurações do seu
              navegador.
            </p>
