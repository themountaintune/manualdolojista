...
const terms = [
	{ term: "A/B Test", description: "Experimento para comparar duas versões de uma página ou elemento.", letter: "A" },
	{ term: "CAC", description: "Custo de Aquisição de Cliente - quanto você gasta para conquistar um novo cliente.", letter: "C" },
	{ term: "CRO", description: "Conversion Rate Optimization - otimização da taxa de conversão.", letter: "C" },
	{ term: "CTR", description: "Click-Through Rate - taxa de cliques em anúncios ou links.", letter: "C" },
	{ term: "LTV", description: "Lifetime Value - valor do tempo de vida do cliente.", letter: "L" },
	{ term: "MVP", description: "Minimum Viable Product - produto mínimo viável para testar o mercado.", letter: "M" },
	{ term: "Omnichannel", description: "Estratégia que integra todos os canais de venda e atendimento.", letter: "O" },
	{ term: "Pix Parcelado", description: "Pagamento via Pix dividido em parcelas sem juros.", letter: "P" },
	{ term: "ROI", description: "Return on Investment - retorno sobre investimento.", letter: "R" },
	{ term: "SEO", description: "Search Engine Optimization - otimização para mecanismos de busca.", letter: "S" },
