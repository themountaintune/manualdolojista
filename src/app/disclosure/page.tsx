				...
				<div className="max-w-4xl mx-auto">
					...
					<div className="prose prose-invert max-w-none">
						<p className="text-lg text-sub mb-6">
							Transparência é fundamental para nós. Esta página explica como monetizamos nosso conteúdo.
						</p>

						<h2>Links de Afiliados</h2>
						<p>
							Alguns links em nosso site são links de afiliados. Isso significa que podemos receber 
							uma pequena comissão se você fizer uma compra através desses links, sem custo adicional para você.
						</p>
						...
						<h2>Como Testamos</h2>
						<p>
							Nossa metodologia de teste inclui:
						</p>
						<ul>
						...
						<p>
							Quando temos parcerias comerciais, sempre deixamos claro no conteúdo. 
							Nosso compromisso é manter a transparência total com nossos leitores.
						</p>

						<h2>Conteúdo Patrocinado</h2>
						<p>
							Qualquer conteúdo patrocinado será claramente identificado como tal. 
							Mesmo em conteúdo patrocinado, mantemos nossos padrões de qualidade e honestidade.
						</p>

						<h2>Suporte ao Manual do Lojista</h2>
						<p>
							Ao usar nossos links de afiliados, você nos ajuda a:
						</p>
						<ul>
						...
						<h2>Dúvidas?</h2>
						<p>
							Se você tiver dúvidas sobre nossa política de disclosure ou quiser mais 
							informações sobre como testamos produtos e serviços, entre em contato conosco.
						</p>
					</div>
				</div>
			</main>
