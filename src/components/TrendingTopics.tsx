...
export function TrendingTopics(): JSX.Element {
	const articles = [
		...
		},
		{
			...
			excerpt: "Take an exclusive behind-the-scenes look at the creation of beauty products. Learn about commitment to quality, innovation, and the meticulous process that goes into each product.",
			image: "https://placehold.co/389x240",
			author: "Jane Doe",
			readTime: "5min read"
		},
		{
			...
			excerpt: "Gain insights from a renowned beauty influencer or expert in an exclusive interview. Discover their favorite beauty tips, product recommendations, and the secrets behind their success in the industry.",
			image: "https://placehold.co/389x240",
			author: "Jane Doe",
			readTime: "5min read"
		},
